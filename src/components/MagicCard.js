...
import classNames from "classnames"; // Importation de classnames
...
export function MagicCard({
  ...
  return (
    <div
      ref={cardRef}
      className={classNames("group relative flex size-full rounded-xl", className)} // Utilisation de classNames
    >
